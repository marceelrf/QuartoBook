...
1.  Qual formato de arquivo não é gerado por `bwa index`.
2.  Qual a cobertura das amostras para os marcadores `PentaE`, `PentaD`, `vWA` **`[PODEM SER OUTROS]`**.
3.  Qual é a profundidade média de cobertura das leituras alinhadas?
4.  Há alguma região com uma alta porcentagem de *mismatches* ou *indels* no genes MC1R e SLC45A2?
5.  Quão uniformemente as leituras estão distribuídas no genoma de referência?
