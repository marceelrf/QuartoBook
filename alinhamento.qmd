...
4.  O que o programa SAMtools realiza no fluxo de análise de dados de alinhamento de DNA?
...
5.  Qual é a profundidade média de cobertura das leituras alinhadas para o gene MC1R?
    ...
    Use o comando a baixo para amostras Exoma e WGS:

    `samtools coverage -b bam_list.txt -r {chr}:{start}-{end} > cov.txt`
    :::
